...
#	define LeadingZeroes(x)  ::Luna::Utility::CountLeadingZeroes(x)
#	define TrailingZeroes(x) ::Luna::Utility::CountTrailingZeroes(x)
#	define TrailingOnes(x)   ::Luna::Utility::CountTrailingZeroes(~uint32_t(x))
#endif
