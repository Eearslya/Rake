...
class Sampler : public HashedObject<Sampler>, public Cookie, public InternalSyncEnabled, Utility::NonCopyable {
 public:
	Sampler(Utility::Hash hash, Device& device, const SamplerCreateInfo& info);
	~Sampler() noexcept;
