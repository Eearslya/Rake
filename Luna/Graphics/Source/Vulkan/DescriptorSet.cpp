...
DescriptorSetAllocator::DescriptorSetAllocator(Utility::Hash hash,
                                               Device& device,
...
std::pair<vk::DescriptorSet, bool> DescriptorSetAllocator::Find(uint32_t threadIndex, Utility::Hash hash) {
