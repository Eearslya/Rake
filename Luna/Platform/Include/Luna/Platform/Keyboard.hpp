...
class Keyboard : public Utility::Module::Registrar<Keyboard> {
	static inline const bool Registered = Register("Keyboard", Stage::Never, Depends<Window>());
 ...
 public:
	...
	Utility::CancellableDelegate<Key, InputAction, InputMods, bool> OnKey;
	Utility::CancellableDelegate<char> OnChar;
